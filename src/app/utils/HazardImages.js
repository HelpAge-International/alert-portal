...
var HazardImages = (function () {
    function HazardImages() {
    }
    HazardImages.prototype.getMapOfSVG = function () {
        var map = new Map();
        map.set(0, "cold_wave");
        map.set(1, "conflict");
        map.set(2, "cyclone");
    ...
    HazardImages.prototype.getMapOfCSS = function () {
        var map = new Map();
    ...
    HazardImages.init = function () {
        return new HazardImages();
    };
    HazardImages.prototype.get = function (int) {
        return HazardImages.info + this.getMapOfSVG().get(int) + HazardImages.ending;
    };
    HazardImages.prototype.getCSS = function (int) {
        return this.getMapOfCSS().get(int);
    };
    return HazardImages;
}());
HazardImages.ending = "_blue.svg";
HazardImages.info = "/assets/images/hazards/marker/";
exports.HazardImages = HazardImages;
