...
@Component({
  ...
  templateUrl: './system-admin-view-coc.component.html',
  styleUrls: ['./system-admin-view-coc.component.scss']
})
export class SystemAdminViewCocComponent implements OnInit {
