...
@Component({
  selector: 'app-network-country-admin-view-coc',
  templateUrl: './network-country-admin-view-coc.component.html',
  styleUrls: ['./network-country-admin-view-coc.component.scss']
})
export class NetworkCountryAdminViewCocComponent implements OnInit {
