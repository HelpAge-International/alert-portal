...
@Component({
  selector: 'app-network-country-profile-documents',
  templateUrl: './network-country-profile-documents.component.html',
  styleUrls: ['./network-country-profile-documents.component.scss']
})
export class NetworkCountryProfileDocumentsComponent implements OnInit, OnDestroy {
  UserType: any;
                ...
                this.af.database.object( Constants.APP_STATUS + '/networkCountry/' + this.networkId + '/' + this.networkCountryId)
                  ...
                  .subscribe( network => {
                    ...
                    // } else {
                      ...
                      this.af.database.list(Constants.APP_STATUS + '/document/' + this.networkCountryId, this.docFilter)
                        .takeUntil(this.ngUnsubscribe)
                        .subscribe(_ => {
                          let docs = _;
                          console.log(docs)
